      ...
      <Container>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            Rendez votre apprentissage agréable et engageant avec notre plateforme ! Personnalisez votre parcours éducatif pour qu'il corresponde à vos besoins et profitez des avantages suivants :
            </Typography>
